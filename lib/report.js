...
import { clusterObservations, isHeartbeatText } from "./analysis.js";
...
export function buildCandidateReport(observations, config, reviews = new Map()) {
  const candidateObservations = observations.filter((observation) => !isHeartbeatText(observation.excerpt));
